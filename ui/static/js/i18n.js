...
const translations = {
    'zh-CN': {
        ...
        'mode.simple': '简易',
        'mode.advanced': '高级',
        'label.modeSelect': '模式选择',
        'mode.speechOnly': '仅语音识别',
        'mode.speechTranslation': '识别+翻译',
        'label.deepseekKey': 'DeepSeek API Key',
        'link.getDeepseekKey': '获取 DeepSeek API Key →',
        'hint.translationOnlyKey': '仅在开启翻译时使用。',
        'hint.dashscopeKeySimple': '语音识别使用阿里千问语音识别。',
        'start.quickStart': '三步开始使用',
        'start.stepKey': '填写 API Key',
        'start.stepLang': '设置翻译',
        'start.stepGo': '启动服务',
        'start.goHint': '完成上面两步后，点击右上角的「启动服务」即可开始使用。',
        'section.asrTuning': '高级识别参数',
        'section.vrcxBridge': 'VRCX 集成',
        'section.maintenance': '重置',
        'btn.loading': '加载中',
        'btn.starting': '启动中...',
        'btn.stopping': '停止中...',
        'btn.openPanel': '小面板',
        ...
        'api.hyMt2': 'Hy-MT2（WebSocket 流式修订翻译）',
        'label.hyMt2WsUrl': 'Hy-MT2 WebSocket 地址',
        'hint.hyMt2WsUrl': '填写 Hy-MT2 流式修订翻译服务的 WebSocket 地址（例如 ws://127.0.0.1:18765）。该地址不内置默认值，请自行填写（也可在 .env 中设置 HYMT2_WEBSOCKET_URL）。',
        'msg.hyMt2WsUrlRequired': '请填写 Hy-MT2 WebSocket 地址',
        'label.localDevice': '运行位置',
        'option.deviceAuto': '自动（独显优先）',
        'option.deviceCpu': 'CPU',
        'label.deviceIntegrated': '核显',
        'hint.localInferenceDevice': '仅对 Qwen3-ASR 生效；SenseVoice 固定在 CPU 上运行。',
        'hint.hymt2LocalDevice': '仅影响本地 Hy-MT2 模型；切换后模型会立即按新设置重新加载。',
        'label.hymt2Backend': 'Hy-MT2 接入方式',
        'label.localInferenceBackend': '模型运行方式',
        'option.localInferenceLocal': '本机运行',
        'option.localInferenceRemote': '远程服务器运行',
        'label.localInferenceServerUrl': '统一推理服务器地址',
        'hint.localInferenceServerUrl': 'SenseVoice、Qwen3-ASR 与 Hy-MT2 共用这个 WebSocket 地址。',
        'hint.hymt2UsesUnifiedInference': 'Hy-MT2 跟随「本地模型」中的统一运行方式与服务器地址。',
        'msg.localInferenceServerUrlRequired': '请填写统一推理服务器地址',
        'option.hymt2BackendApi': '外部 API（WebSocket 独立服务）',
        'option.hymt2BackendLocal': '本地模型（GGUF 进程内推理）',
        'link.hyMt2DeployGuide': '查看外部服务部署指南 →',
        'link.manageInLocalModels': '前往「本地模型」下载与管理 →',
        'status.localModelChecking': '检测中...',
        'status.localModelDownloading': '⏳ 下载中',
        'status.localModelReady': '✅ 已就绪',
        'status.localModelMissing': '❌ 未就绪',
        'status.hymt2Missing': '❌ 未就绪（点下方按钮自动下载，或手动放置 GGUF 至 local_asr_models/hymt2/）',
        'status.hymt2LocalChecking': '正在检测本地模型...',
        'status.hymt2LocalReady': '本地 Hy-MT2 模型已就绪。',
        'status.hymt2LocalMissing': '本地 Hy-MT2 模型尚未就绪。',
        'status.hymt2EngineLoading': '⏳ 模型加载中（首次加载可能需要数十秒，状态自动刷新）...',
        'status.hymt2EngineLoaded': '✅ 模型已加载（停止服务时自动卸载）。',
        'label.localInferenceModels': '🎙️ 语音识别模型（ASR）',
        'label.localMtModels': '🌐 机器翻译模型（MT）',
        'localModels.hymt2Name': 'Hy-MT2 1.8B（流式修订翻译）',
        'localModels.hymt2Desc': '基于混元 1.8B 多语言流式修订架构，支持在说话过程中根据上下文自动修正流式译文。',
        'btn.downloadHymt2': '一键下载本地 Hy-MT2 模型',
        'label.streamingMode': '流式翻译模式',
        'hint.streamingMode': '启用后会边说边翻译，不用等整句话说完才出结果。请注意这会大幅增加 token 用量。',
        'hint.streamingModeHymt': '启用后会边说边流式修订翻译，不用等整句话说完才出结果；关闭后仅在整句说完后翻译。',
        'feature.llmStreamingPromo': '新：推荐尝试LLM流式翻译',
        'feature.switchToLlmStreaming': '点此切换到LLM流式翻译',
        'feature.alreadyUsingLlmStreaming': '您已在使用LLM流式翻译',
        ...
        'section.localInferenceSettings': '本地模型',
        'section.localModels': '本地模型',
        'label.asrBackend': '识别后端',
        'asr.qwen': 'Qwen3 ASR（推荐）',
        'asr.qwenAudio3': 'Qwen-Audio-3.1 ASR（最新）',
        ...
        'local.needsLocalVersion': '（需要 LocalInference 版本）',
        'localInference.engine.sensevoice': 'SenseVoice Small（快速、CPU）',
        'localInference.engine.qwen3': 'Qwen3-ASR（准确、GPU）',
        'localInference.engine.sensevoiceName': 'SenseVoice Small',
        'localInference.engine.qwen3Name': 'Qwen3-ASR',
        'localInference.engine.sensevoiceHint': 'INT8 ONNX，固定 CPU。',
        'localInference.engine.qwen3Hint': '两个模型组成：音频编码器（ONNX）+ 识别解码器（GGUF），可分别放在 CPU 或显卡上。',
        'localInference.part.encoder': '音频编码器（ONNX）',
        'localInference.part.decoder': '识别解码器（GGUF）',
        'localInference.placement.gpu': '显卡',
        'localInference.placement.cpu': 'CPU',
        'localInference.vramLabel': '显存',
        'localInference.vramTotal': '合计显存',
        'label.localEncoderDevice': '音频编码器运行位置',
        'option.encoderDeviceAuto': '跟随上面的运行位置',
        'option.encoderDeviceGpu': '显卡（DirectML）',
        'option.encoderDeviceCpu': 'CPU',
        'hint.localEncoderDevice': '放显卡上明显更快（24 秒音频约 400ms → 70ms），代价是多占显存。放 CPU 则不受显卡上其他负载影响，边打游戏边用更稳。',
        'label.sonioxKey': 'Soniox API Key（可选）',
        'hint.sonioxKey': '支持60+语言的语音识别。',
        'label.pauseOnMute': '游戏静音时暂停转录',
        'hint.pauseOnMute': '只有当游戏内麦克风开启时，才会识别您说的话',
        'label.enableHotWords': '启用热词',
        'hint.enableHotWords': '提高特定词汇的识别准确度',
        'label.muteDelay': '静音延迟（毫秒）',
        ...
        'label.bypassOscUdpPortCheck': '跳过 VRChat OSC 端口启动提醒',
        'hint.bypassOscUdpPortCheck':
            '开启后启动/重启服务时不再检查并提醒 UDP 端口占用（可能影响游戏接收 OSC，仅在知情时使用）',
        ...
        'option.micReselect': '麦克风选择已失效，请重新选择',
        'button.rescanMics': '刷新设备',
        'option.micDisconnected': '所选麦克风未连接，等待恢复',
        ...
        'label.localInferenceEngine': '本地识别引擎',
        'label.localInferenceDevice': '计算设备',
        'label.localInferenceLanguage': '语言提示',
        'label.localVadMode': '本地 VAD 模式',
        'label.localVadThreshold': '本地 VAD 阈值',
        'label.localMinSpeechDuration': '最短语音时长（毫秒）',
        'label.localMaxSpeechDuration': '单段最长语音采集（毫秒）',
        'label.localSilenceDuration': '句子结束静音（毫秒）',
        'hint.localSilenceDuration': '连续静音达到该时长时，判定整句话说完，提交最终识别结果（本地识别断句）。',
        'label.localPreSpeechDuration': '起声预缓冲（毫秒）',
        'hint.localPreSpeechDuration': '开口瞬间向前回补的音频时长，统一作用于在线 API 门控与本地识别断句，避免漏掉句首第一个字。',
        'label.localIncrementalAsr': '启用增量识别',
        'label.localIncrementalTriggerSilence': '增量更新静音（毫秒）',
        'hint.localIncrementalTriggerSilence': '说话中出现该时长的短停顿即视为一个分句（逗号位置），立即触发一次增量识别。',
        'label.localIncrementalMinInterval': '增量更新最小间隔（毫秒）',
        'hint.localIncrementalMinInterval': '限流：两次增量更新之间的最小间隔。',
        'label.localIncrementalFallbackInterval': '增量更新最长间隔（毫秒）',
        'hint.localIncrementalFallbackInterval': '兜底：连续该时长没有任何更新时，强制刷新一次中间结果。',
        'hint.localInferenceNotChecked': '尚未检查本地模型状态',
        'hint.localInferenceStatus': '首次使用前请先下载对应引擎模型和运行时。',
        'hint.localInferenceNeedsDownload': '当前引擎尚未准备好，请先下载模型和运行时。',
        'status.downloading': '下载中',
        'status.localInferenceReady': '{engine} 已准备就绪',
        'btn.downloadLocalInference': '下载本地识别模型',
        ...
        'msg.udpPortOccupied': 'UDP 端口被占用，服务仍会继续启动，但游戏可能收不到 OSC/字幕消息。',
        'msg.udpPortBlockedCancel': '服务会继续启动；如游戏收不到 OSC/字幕，请释放该 UDP 端口或关闭占用进程后再试。',
        'msg.vrchatOscNotListeningWarning': '未检测到 VRChat 正在监听本机 UDP {port} 端口。您可能未启动游戏，或未开启 OSC 端口。如需开启，请在游戏轮盘菜单的 Options（选项）里的 OSC 中打开开关。',
        'msg.vrchatOscDisabledWarning': '检测到 VRChat 正在运行，但它没有开启 OSC。请在游戏内打开圆盘菜单（Action Menu）最顶层的 选项/Options → OSC → 已开启/Enabled，然后重启本服务。',
        'msg.vrchatOscPortMismatchWarning': 'VRChat 实际接收 OSC 的端口是 {actualPort}，与当前设置的发送端口 {port} 不一致，消息可能发不到游戏里。请在高级设置里把 OSC 发送目标端口改成 {actualPort}。',
        ...
        'msg.localInferenceDownloadStarted': '已开始下载本地识别模型',
        'msg.localInferenceDownloadFailed': '下载本地识别模型失败',
        'msg.localInferenceDisabledInBuild': '当前标准版未启用本地识别功能',
        'msg.localInferenceNotReady': '本地识别模型尚未准备好，请先下载',
        'msg.localInferenceNeedPythonDeps': '主模型已在本地，但缺少运行依赖: {deps}。请执行 pip install -r requirements-local-inference.txt 后重启应用。',
        'msg.localInferenceNeedSilero': 'Silero VAD（ONNX）未就绪。请在下方点击「下载本地识别模型」。',
        ...
        'msg.simpleDashscopeKeyMissing': '简易模式需要阿里云 DashScope API Key 才能启动语音识别。请先填写阿里 Key。',
        'msg.simpleDeepseekKeyMissing': '当前开启了翻译，简易模式需要 DeepSeek API Key。请先填写 DeepSeek Key。',
    ...
    'en': {
        ...
        // Tab navigation & quick start
        'tab.start': 'Start',
        'tab.translation': 'Translation',
        'tab.asr': 'Speech Recognition',
        'tab.panel': 'Mini Panel',
        'tab.advanced': 'Advanced',
        'mode.simple': 'Simple',
        'mode.advanced': 'Advanced',
        'label.modeSelect': 'Mode selection',
        'mode.speechOnly': 'Recognition only',
        'mode.speechTranslation': 'Recognition + translation',
        'label.deepseekKey': 'DeepSeek API Key',
        'link.getDeepseekKey': 'Get a DeepSeek API Key →',
        'hint.translationOnlyKey': 'Only used when translation is enabled.',
        'hint.dashscopeKeySimple': 'Speech recognition uses Alibaba Qwen ASR.',
        'start.quickStart': 'Get started in 3 steps',
        'start.stepKey': 'Enter your API Key',
        'start.stepLang': 'Set up translation',
        'start.stepGo': 'Start the service',
        'start.goHint': 'Once steps 1 and 2 are done, click "Start Service" in the top right corner.',
        'section.asrTuning': 'Advanced recognition tuning',
        'section.vrcxBridge': 'VRCX Integration',
        ...
        'api.hyMt2': 'Hy-MT2 (WebSocket Streaming Revision Translation)',
        'label.hyMt2WsUrl': 'Hy-MT2 WebSocket Address',
        'hint.hyMt2WsUrl': 'Enter the WebSocket address of your Hy-MT2 streaming revision translation service (e.g. ws://127.0.0.1:18765). No default is provided — fill it in yourself (or set HYMT2_WEBSOCKET_URL in .env).',
        'msg.hyMt2WsUrlRequired': 'Please fill in the Hy-MT2 WebSocket address',
        'label.localDevice': 'Run on',
        'option.deviceAuto': 'Auto (prefer discrete GPU)',
        'option.deviceCpu': 'CPU',
        'label.deviceIntegrated': 'integrated',
        'hint.localInferenceDevice': 'Applies to Qwen3-ASR only; SenseVoice always runs on the CPU.',
        'hint.hymt2LocalDevice': 'Applies to the local Hy-MT2 model only; the model reloads immediately with the new setting.',
        'label.hymt2Backend': 'Hy-MT2 Access Method',
        'label.localInferenceBackend': 'Model execution',
        'option.localInferenceLocal': 'Run on this PC',
        'option.localInferenceRemote': 'Run on remote server',
        'label.localInferenceServerUrl': 'Unified inference server',
        'hint.localInferenceServerUrl': 'SenseVoice, Qwen3-ASR, and Hy-MT2 share this WebSocket endpoint.',
        'hint.hymt2UsesUnifiedInference': 'Hy-MT2 follows the execution mode and server under Local Models.',
        'msg.localInferenceServerUrlRequired': 'Enter the unified inference server address',
        'option.hymt2BackendApi': 'External API (WebSocket Service)',
        'option.hymt2BackendLocal': 'Local Model (GGUF In-process Inference)',
        'link.hyMt2DeployGuide': 'View external service deployment guide →',
        'link.manageInLocalModels': 'Manage and download in "Local Models" →',
        'status.localModelChecking': 'Checking...',
        'status.localModelDownloading': '⏳ Downloading',
        'status.localModelReady': '✅ Ready',
        'status.localModelMissing': '❌ Not ready',
        'status.hymt2Missing': '❌ Not ready (download it below, or place the GGUF in local_asr_models/hymt2/)',
        'status.hymt2LocalChecking': 'Checking the local model...',
        'status.hymt2LocalReady': 'The local Hy-MT2 model is ready.',
        'status.hymt2LocalMissing': 'The local Hy-MT2 model is not ready yet.',
        'status.hymt2EngineLoading': '⏳ Loading model (first load may take a while, status auto-refreshes)...',
        'status.hymt2EngineLoaded': '✅ Model loaded (unloaded automatically when the service stops).',
        'label.localInferenceModels': '🎙️ Speech Recognition Models (ASR)',
        'label.localMtModels': '🌐 Machine Translation Models (MT)',
        'localModels.hymt2Name': 'Hy-MT2 1.8B (Streaming Revision Translation)',
        'localModels.hymt2Desc': 'Based on HunYuan 1.8B multilingual streaming revision architecture, dynamically revising translations with context.',
        'btn.downloadHymt2': 'Download Local Hy-MT2 Model',
        ...
        'hint.streamingModeHymt': 'When enabled, real-time streaming revision translation occurs while speaking; when disabled, translation only occurs after finishing the full sentence.',
        ...
        'feature.alreadyUsingLlmStreaming': 'You are already using LLM streaming translation',
        ...
        'local.needsLocalVersion': '(requires the LocalInference version)',
        'localInference.engine.sensevoice': 'SenseVoice Small (Fast, CPU)',
        'localInference.engine.qwen3': 'Qwen3-ASR (Accurate, GPU)',
        'localInference.engine.sensevoiceName': 'SenseVoice Small',
        'localInference.engine.qwen3Name': 'Qwen3-ASR',
        'localInference.engine.sensevoiceHint': 'INT8 ONNX on CPU.',
        'localInference.engine.qwen3Hint': 'Two models: an ONNX audio encoder plus a GGUF decoder, each placeable on CPU or GPU.',
        'localInference.part.encoder': 'Audio encoder (ONNX)',
        'localInference.part.decoder': 'Recognition decoder (GGUF)',
        'localInference.placement.gpu': 'GPU',
        'localInference.placement.cpu': 'CPU',
        'localInference.vramLabel': 'VRAM',
        'localInference.vramTotal': 'Total VRAM',
        'label.localEncoderDevice': 'Audio encoder runs on',
        'option.encoderDeviceAuto': 'Same as above',
        'option.encoderDeviceGpu': 'GPU (DirectML)',
        'option.encoderDeviceCpu': 'CPU',
        'hint.localEncoderDevice': 'Much faster on the GPU (24s of audio: ~400ms to ~70ms) at the cost of VRAM. On CPU it is unaffected by other GPU load, which is steadier while gaming.',
        'label.sonioxKey': 'Soniox API Key (optional)',
        'hint.sonioxKey': 'Supports 60+ languages for speech recognition.',
        'label.pauseOnMute': 'Pause recognition when muted in game',
        'hint.pauseOnMute': 'Your speech is only recognized while your in-game mic is on',
        'label.enableHotWords': 'Enable Hot Words',
        'hint.enableHotWords': 'Improves recognition accuracy for specific words',
        'label.muteDelay': 'Mute Delay (ms)',
        ...
        'label.bypassOscUdpPortCheck': 'Skip VRChat OSC startup warnings',
        'hint.bypassOscUdpPortCheck':
            'When on, start/restart will not check and warn when the OSC UDP port appears in use (may break in-game OSC; use only if you understand the risk).',
        ...
        'option.micReselect': 'Microphone selection expired — please select again',
        'button.rescanMics': 'Refresh devices',
        'option.micDisconnected': 'Selected microphone disconnected; waiting to reconnect',
        ...
        'label.localInferenceEngine': 'Local ASR Engine',
        'label.localInferenceDevice': 'Compute Device',
        'label.localInferenceLanguage': 'Language Hint',
        'label.localVadMode': 'Local VAD Mode',
        'label.localVadThreshold': 'Local VAD Threshold',
        'label.localMinSpeechDuration': 'Min Speech Duration (ms)',
        'label.localMaxSpeechDuration': 'Max speech per utterance (ms)',
        'label.localSilenceDuration': 'Sentence End Silence (ms)',
        'hint.localSilenceDuration': 'When continuous silence reaches this duration, the sentence is considered complete and the final result is committed (local segmentation).',
        'label.localPreSpeechDuration': 'Pre-speech Buffer (ms)',
        'hint.localPreSpeechDuration': 'Audio looked back when speech starts. Applies to both online API gating and local segmentation, so the beginning of a sentence is not lost.',
        'label.localIncrementalAsr': 'Enable Incremental ASR',
        'label.localIncrementalTriggerSilence': 'Incremental Update Silence (ms)',
        'hint.localIncrementalTriggerSilence': 'A brief pause of this length during speech is treated as a clause break (e.g., comma position) and triggers one incremental recognition pass.',
        'label.localIncrementalMinInterval': 'Min Update Interval (ms)',
        'hint.localIncrementalMinInterval': 'Rate limit: minimum gap between two incremental updates.',
        'label.localIncrementalFallbackInterval': 'Max Update Interval (ms)',
        'hint.localIncrementalFallbackInterval': 'Fallback: force one interim refresh if no update happens within this period.',
        'hint.localInferenceNotChecked': 'Local model status has not been checked yet',
        'hint.localInferenceStatus': 'Download the selected engine model and runtime before first use.',
        'hint.localInferenceNeedsDownload': 'The selected engine is not ready yet. Please download the model and runtime first.',
        'status.downloading': 'Downloading',
        'status.localInferenceReady': '{engine} is ready',
        'btn.downloadLocalInference': 'Download Local ASR Model',
        ...
        'msg.udpPortOccupied': 'UDP port is in use. The service will keep starting, but the game may not receive OSC/subtitle messages.',
        'msg.udpPortBlockedCancel': 'The service will keep starting; if OSC/subtitles do not arrive in game, free the UDP port or close the conflicting process and try again.',
        'msg.vrchatOscNotListeningWarning': 'VRChat was not detected listening on local UDP port {port}. The game may not be running, or its OSC port may be disabled. To enable it, open the in-game radial menu, go to Options > OSC, and turn the switch on.',
        'msg.vrchatOscDisabledWarning': 'VRChat is running, but its OSC service was not found. In game, open the Action Menu, go to Options > OSC at the top level and switch it to Enabled, then restart this service.',
        'msg.vrchatOscPortMismatchWarning': 'VRChat receives OSC on port {actualPort}, which does not match the configured send port {port}, so messages may never reach the game. Change the OSC send target port to {actualPort} in advanced settings.',
        ...
        'msg.localInferenceDownloadStarted': 'Started downloading the local ASR model',
        'msg.localInferenceDownloadFailed': 'Failed to download the local ASR model',
        'msg.localInferenceDisabledInBuild': 'Local inference is disabled in this standard build',
        'msg.localInferenceNotReady': 'The local ASR model is not ready yet. Please download it first',
        'msg.localInferenceNeedPythonDeps': 'Model files are present but Python dependencies are missing: {deps}. Run: pip install -r requirements-local-inference.txt then restart.',
        'msg.localInferenceNeedSilero': 'Silero VAD (ONNX) is missing. Click download under Local Model settings.',
        ...
        'msg.simpleDashscopeKeyMissing': 'Simple mode needs an Alibaba Cloud DashScope API Key before speech recognition can start.',
        'msg.simpleDeepseekKeyMissing': 'Translation is enabled, so simple mode needs a DeepSeek API Key.',
    ...
    'ja': {
        ...
        'mode.simple': 'シンプル',
        'mode.advanced': '詳細',
        'label.modeSelect': 'モード選択',
        'mode.speechOnly': '音声認識のみ',
        'mode.speechTranslation': '認識+翻訳',
        'label.deepseekKey': 'DeepSeek API Key',
        'link.getDeepseekKey': 'DeepSeek API キーを取得 →',
        'hint.translationOnlyKey': '翻訳が有効なときのみ使用されます。',
        'hint.dashscopeKeySimple': '音声認識にはアリババ Qwen 音声認識を使用します。',
        'start.quickStart': '3ステップで始める',
        'start.stepKey': 'APIキーを入力',
        'start.stepLang': '翻訳を設定',
        'start.stepGo': 'サービスを起動',
        'start.goHint': '上の2ステップが終わったら、右上の「サービスを起動」をクリックしてください。',
        'section.asrTuning': '認識の詳細チューニング',
        'section.vrcxBridge': 'VRCX 連携',
        'section.maintenance': 'リセット',
        'btn.loading': '読み込み中...',
        'btn.starting': '開始中...',
        'btn.stopping': '停止中...',
        'btn.openPanel': 'ミニパネル',
        ...
        'api.hyMt2': 'Hy-MT2（WebSocket ストリーミング改訂翻訳）',
        'label.hyMt2WsUrl': 'Hy-MT2 WebSocket アドレス',
        'hint.hyMt2WsUrl': 'Hy-MT2 ストリーミング改訂翻訳サービスの WebSocket アドレスを入力してください（例: ws://127.0.0.1:18765）。既定値は用意されていません。ご自身で記入してください（.env の HYMT2_WEBSOCKET_URL でも設定可）。',
        'msg.hyMt2WsUrlRequired': 'Hy-MT2 WebSocket アドレスを入力してください',
        'label.localDevice': '実行デバイス',
        'option.deviceAuto': '自動（外部 GPU 優先）',
        'option.deviceCpu': 'CPU',
        'label.deviceIntegrated': '内蔵GPU',
        'hint.localInferenceDevice': 'Qwen3-ASR にのみ適用されます。SenseVoice は常に CPU で動作します。',
        'hint.hymt2LocalDevice': 'ローカル Hy-MT2 モデルのみに適用されます。切り替え後、新しい設定でモデルをすぐに再読み込みします。',
        'label.hymt2Backend': 'Hy-MT2 接続方式',
        'label.localInferenceBackend': 'モデル実行方式',
        'option.localInferenceLocal': 'このPCで実行',
        'option.localInferenceRemote': 'リモートサーバーで実行',
        'label.localInferenceServerUrl': '統合推論サーバーアドレス',
        'hint.localInferenceServerUrl': 'SenseVoice、Qwen3-ASR、Hy-MT2 は同じ WebSocket アドレスを使用します。',
        'hint.hymt2UsesUnifiedInference': 'Hy-MT2 は「ローカルモデル」の実行方式とサーバー設定に従います。',
        'msg.localInferenceServerUrlRequired': '統合推論サーバーアドレスを入力してください',
        'option.hymt2BackendApi': '外部 API（WebSocket サービス）',
        'option.hymt2BackendLocal': 'ローカルモデル（GGUF プロセス内推論）',
        'link.hyMt2DeployGuide': '外部サービスデプロイガイドを見る →',
        'link.manageInLocalModels': '「ローカルモデル」で管理・ダウンロード →',
        'status.localModelChecking': '確認中...',
        'status.localModelDownloading': '⏳ ダウンロード中',
        'status.localModelReady': '✅ 準備完了',
        'status.localModelMissing': '❌ 未準備',
        'status.hymt2Missing': '❌ 未準備（下のボタンで自動ダウンロード、または GGUF を local_asr_models/hymt2/ に配置）',
        'status.hymt2LocalChecking': 'ローカルモデルを確認中...',
        'status.hymt2LocalReady': 'ローカル Hy-MT2 モデルは準備完了です。',
        'status.hymt2LocalMissing': 'ローカル Hy-MT2 モデルはまだ準備できていません。',
        'status.hymt2EngineLoading': '⏳ モデルをロード中です（初回は数十秒かかる場合があります。状態は自動更新されます）...',
        'status.hymt2EngineLoaded': '✅ モデルがロード済みです（サービス停止時に自動的に解放されます）。',
        'label.localInferenceModels': '🎙️ 音声認識モデル（ASR）',
        'label.localMtModels': '🌐 機械翻訳モデル（MT）',
        'localModels.hymt2Name': 'Hy-MT2 1.8B（ストリーミング改訂翻訳）',
        'localModels.hymt2Desc': '混元 1.8B 多言語ストリーミング改訂モデルに基づき、発話中にコンテキストに応じて自動的に訳文を修正します。',
        'btn.downloadHymt2': 'ローカル Hy-MT2 モデルをダウンロード',
        'label.streamingMode': 'ストリーミング翻訳モード',
        'hint.streamingMode': '有効にすると、話し終わるまで待たずに、話している途中から翻訳が出ます。token 使用量が大幅に増える点に注意してください。',
        'hint.streamingModeHymt': '有効にすると、発話中にリアルタイム改訂ストリーミング翻訳を行います。無効にすると、文全体の発話終了後に翻訳します。',
        'feature.llmStreamingPromo': '新：LLM ストリーミング翻訳のお試しをおすすめします',
        'feature.switchToLlmStreaming': 'LLM ストリーミング翻訳に切り替える',
        'feature.alreadyUsingLlmStreaming': 'LLM ストリーミング翻訳を使用中です',
        ...
        'section.localInferenceSettings': 'ローカルモデル',
        'section.localModels': 'ローカルモデル',
        ...
        'local.needsLocalVersion': '（LocalInference バージョンが必要）',
        'localInference.engine.sensevoice': 'SenseVoice Small（高速、CPU）',
        'localInference.engine.qwen3': 'Qwen3-ASR（高精度、GPU）',
        'localInference.engine.sensevoiceName': 'SenseVoice Small',
        'localInference.engine.qwen3Name': 'Qwen3-ASR',
        'localInference.engine.sensevoiceHint': 'INT8 ONNX（CPU）。',
        'localInference.engine.qwen3Hint': '2 つのモデル構成：音声エンコーダ（ONNX）＋認識デコーダ（GGUF）。それぞれ CPU / GPU に配置できます。',
        'localInference.part.encoder': '音声エンコーダ（ONNX）',
        'localInference.part.decoder': '認識デコーダ（GGUF）',
        'localInference.placement.gpu': 'GPU',
        'localInference.placement.cpu': 'CPU',
        'localInference.vramLabel': 'VRAM',
        'localInference.vramTotal': 'VRAM 合計',
        'label.localEncoderDevice': '音声エンコーダの実行場所',
        'option.encoderDeviceAuto': '上の設定に従う',
        'option.encoderDeviceGpu': 'GPU（DirectML）',
        'option.encoderDeviceCpu': 'CPU',
        'hint.localEncoderDevice': 'GPU に置くと大幅に速くなります（24 秒の音声で約 400ms → 70ms）が VRAM を消費します。CPU なら GPU の他の負荷に影響されず、ゲーム中でも安定します。',
        'label.sonioxKey': 'Soniox API Key（任意）',
        'hint.sonioxKey': '60 以上の言語の音声認識に対応しています。',
        'label.pauseOnMute': 'ゲームでミュート中は文字起こしを停止',
        'hint.pauseOnMute': 'ゲーム内のマイクがオンのときだけ音声を認識します',
        'label.enableHotWords': 'ホットワードを有効化',
        'hint.enableHotWords': '特定語彙の認識精度を向上させます',
        'label.muteDelay': 'ミュート遅延（ミリ秒）',
        ...
        'label.bypassOscUdpPortCheck': 'VRChat OSC 起動時警告をスキップ',
        'hint.bypassOscUdpPortCheck':
            'オンにすると起動・再起動時に UDP ポート占有を確認・警告しません（ゲーム側 OSC に影響する可能性があります。理解した上で利用してください）',
        ...
        'option.micReselect': 'マイクの選択が無効です。選び直してください',
        'button.rescanMics': 'デバイス更新',
        'option.micDisconnected': '選択したマイクが未接続です。再接続を待っています',
        ...
        'label.localInferenceEngine': 'ローカル認識エンジン',
        'label.localInferenceDevice': '計算デバイス',
        'label.localInferenceLanguage': '言語ヒント',
        'label.localVadMode': 'ローカル VAD モード',
        'label.localVadThreshold': 'ローカル VAD しきい値',
        'label.localMinSpeechDuration': '最短発話長（ミリ秒）',
        'label.localMaxSpeechDuration': '1発話あたり最長（ミリ秒）',
        'label.localSilenceDuration': '文終わり無音（ミリ秒）',
        'hint.localSilenceDuration': '連続無音がこの長さに到達すると文が完了したと判定し、最終認識結果を提出します（ローカル識別の区切り）。',
        'label.localPreSpeechDuration': '発話前バッファ（ミリ秒）',
        'hint.localPreSpeechDuration': '発話開始時にさかのぼって補う音声の長さ。オンライン API ゲーティングとローカル識別の区切りの両方に適用され、文の先頭の文字を落としません。',
        'label.localIncrementalAsr': '増量認識を有効化',
        'label.localIncrementalTriggerSilence': '増量更新無音（ミリ秒）',
        'hint.localIncrementalTriggerSilence': '話中のこの長さの短い停止は句の切れ（読点の位置など）とみなし、増量認識を1回即座に実行します。',
        'label.localIncrementalMinInterval': '更新最小間隔（ミリ秒）',
        'hint.localIncrementalMinInterval': 'レート制限：2回の増量更新の間隔の下限。',
        'label.localIncrementalFallbackInterval': '更新最大間隔（ミリ秒）',
        'hint.localIncrementalFallbackInterval': 'フォールバック：この時間内に更新が一切ない場合、中間結果を強制で1回更新します。',
        'hint.localInferenceNotChecked': 'ローカル ASR モデル状態はまだ確認されていません',
        'hint.localInferenceStatus': '初回利用前に、選択したエンジンのモデルとランタイムをダウンロードしてください。',
        'hint.localInferenceNeedsDownload': '選択中のエンジンはまだ準備できていません。先にモデルとランタイムをダウンロードしてください。',
        'status.downloading': 'ダウンロード中',
        'status.localInferenceReady': '{engine} の準備ができました',
        'btn.downloadLocalInference': 'ローカル認識モデルをダウンロード',
        ...
        'msg.udpPortOccupied': 'UDP ポートは使用中です。サービスは続行して起動しますが、ゲームが OSC/字幕を受信できない可能性があります。',
        'msg.udpPortBlockedCancel': 'サービスは続行して起動します。ゲームに OSC/字幕が届かない場合は、該当 UDP ポートを解放するか、使用中のプロセスを終了してから再度お試しください。',
        'msg.vrchatOscNotListeningWarning': 'VRChat がローカル UDP ポート {port} を待ち受けていることを検出できませんでした。ゲームが起動していない、または OSC ポートが無効になっている可能性があります。有効にするには、ゲーム内のラジアルメニューで Options > OSC を開き、スイッチをオンにしてください。',
        'msg.vrchatOscDisabledWarning': 'VRChat は起動していますが、OSC が有効になっていません。ゲーム内で Action Menu（円形メニュー）の最上位にある Options → OSC を Enabled に切り替えてから、本サービスを再起動してください。',
        'msg.vrchatOscPortMismatchWarning': 'VRChat が OSC を受信しているポートは {actualPort} で、設定中の送信ポート {port} と一致しません。メッセージがゲームに届かない可能性があります。詳細設定で OSC 送信先ポートを {actualPort} に変更してください。',
        ...
        'msg.localInferenceDownloadStarted': 'ローカル ASR モデルのダウンロードを開始しました',
        'msg.localInferenceDownloadFailed': 'ローカル ASR モデルのダウンロードに失敗しました',
        'msg.localInferenceDisabledInBuild': 'この標準版ビルドではローカル ASR は無効です',
        'msg.localInferenceNotReady': 'ローカル ASR モデルの準備ができていません。先にダウンロードしてください',
        'msg.localInferenceNeedPythonDeps': 'モデルはありますが Python 依存パッケージが不足: {deps}。pip install -r requirements-local-inference.txt を実行後、再起動。',
        'msg.localInferenceNeedSilero': 'Silero VAD（ONNX）がありません。ローカル ASR 設定からダウンロードしてください。',
        ...
        'msg.simpleDashscopeKeyMissing': '簡易モードで音声認識を開始するには Alibaba Cloud DashScope API Key が必要です。',
        'msg.simpleDeepseekKeyMissing': '翻訳が有効なため、簡易モードでは DeepSeek API Key が必要です。',
    ...
    'ko': {
        ...
        'mode.simple': '간단',
        'mode.advanced': '고급',
        'label.modeSelect': '모드 선택',
        'mode.speechOnly': '음성 인식만',
        'mode.speechTranslation': '인식+번역',
        'label.deepseekKey': 'DeepSeek API Key',
        'link.getDeepseekKey': 'DeepSeek API 키 발급 →',
        'hint.translationOnlyKey': '번역이 켜져 있을 때만 사용됩니다.',
        'hint.dashscopeKeySimple': '음성 인식은 알리바바 Qwen ASR을 사용합니다.',
        'start.quickStart': '3단계로 시작하기',
        'start.stepKey': 'API 키 입력',
        'start.stepLang': '번역 설정',
        'start.stepGo': '서비스 시작',
        'start.goHint': '위 두 단계를 마친 후 오른쪽 위의 "서비스 시작"을 클릭하세요.',
        'section.asrTuning': '고급 인식 설정',
        'section.vrcxBridge': 'VRCX 연동',
        'section.maintenance': '초기화',
        'btn.loading': '로딩 중...',
        'btn.starting': '시작 중...',
        'btn.stopping': '중지 중...',
        'btn.openPanel': '미니 패널',
        ...
        'api.hyMt2': 'Hy-MT2 (WebSocket 스트리밍 개정 번역)',
        'label.hyMt2WsUrl': 'Hy-MT2 WebSocket 주소',
        'hint.hyMt2WsUrl': 'Hy-MT2 스트리밍 개정 번역 서비스의 WebSocket 주소를 입력하세요 (예: ws://127.0.0.1:18765). 기본값이 제공되지 않으므로 직접 입력해야 합니다 (.env의 HYMT2_WEBSOCKET_URL로도 설정 가능).',
        'msg.hyMt2WsUrlRequired': 'Hy-MT2 WebSocket 주소를 입력하세요',
        'label.localDevice': '실행 위치',
        'option.deviceAuto': '자동 (외장 GPU 우선)',
        'option.deviceCpu': 'CPU',
        'label.deviceIntegrated': '내장 GPU',
        'hint.localInferenceDevice': 'Qwen3-ASR 에만 적용되며, SenseVoice 는 항상 CPU 에서 실행됩니다.',
        'hint.hymt2LocalDevice': '로컬 Hy-MT2 모델에만 적용되며, 변경 후 새 설정으로 모델이 즉시 다시 불러워집니다.',
        'label.hymt2Backend': 'Hy-MT2 접속 방식',
        'label.localInferenceBackend': '모델 실행 방식',
        'option.localInferenceLocal': '이 PC에서 실행',
        'option.localInferenceRemote': '원격 서버에서 실행',
        'label.localInferenceServerUrl': '통합 추론 서버 주소',
        'hint.localInferenceServerUrl': 'SenseVoice, Qwen3-ASR, Hy-MT2가 같은 WebSocket 주소를 사용합니다.',
        'hint.hymt2UsesUnifiedInference': 'Hy-MT2는 로컬 모델의 실행 방식과 서버 설정을 따릅니다.',
        'msg.localInferenceServerUrlRequired': '통합 추론 서버 주소를 입력하세요',
        'option.hymt2BackendApi': '외부 API (WebSocket 서비스)',
        'option.hymt2BackendLocal': '로컬 모델 (GGUF 프로세스 내 추론)',
        'link.hyMt2DeployGuide': '외부 서비스 배포 가이드 보기 →',
        'link.manageInLocalModels': '「로컬 모델」에서 관리 및 다운로드 →',
        'status.localModelChecking': '확인 중...',
        'status.localModelDownloading': '⏳ 다운로드 중',
        'status.localModelReady': '✅ 준비 완료',
        'status.localModelMissing': '❌ 준비되지 않음',
        'status.hymt2Missing': '❌ 준비되지 않음 (아래 버튼으로 자동 다운로드하거나 GGUF를 local_asr_models/hymt2/ 에 넣으세요)',
        'status.hymt2LocalChecking': '로컬 모델을 확인하는 중...',
        'status.hymt2LocalReady': '로컬 Hy-MT2 모델이 준비되었습니다.',
        'status.hymt2LocalMissing': '로컬 Hy-MT2 모델이 아직 준비되지 않았습니다.',
        'status.hymt2EngineLoading': '⏳ 모델 로딩 중입니다 (최초 로딩에는 수십 초가 소요될 수 있습니다. 상태는 자동으로 갱신됩니다)...',
        'status.hymt2EngineLoaded': '✅ 모델이 로드되었습니다 (서비스가 중지되면 자동으로 해제됩니다).',
        'label.localInferenceModels': '🎙️ 음성 인식 모델 (ASR)',
        'label.localMtModels': '🌐 기계 번역 모델 (MT)',
        'localModels.hymt2Name': 'Hy-MT2 1.8B (스트리밍 개정 번역)',
        'localModels.hymt2Desc': 'HunYuan 1.8B 다국어 스트리밍 개정 모델 기반으로, 발화 중 문맥에 따라 번역을 실시간 수정합니다.',
        'btn.downloadHymt2': '로컬 Hy-MT2 모델 다운로드',
        'label.streamingMode': '스트리밍 번역 모드',
        'hint.streamingMode': '활성화하면 말을 다 마칠 때까지 기다리지 않고, 말하는 도중부터 번역 결과가 나옵니다. 토큰 사용량이 크게 증가할 수 있습니다.',
        'hint.streamingModeHymt': '활성화하면 말하는 도중에 실시간 개정 스트리밍 번역을 수행합니다. 비활성화하면 전체 문장을 마친 후 번역합니다.',
        'feature.llmStreamingPromo': '신규: LLM 스트리밍 번역 사용을 추천합니다',
        'feature.switchToLlmStreaming': 'LLM 스트리밍 번역으로 전환',
        'feature.alreadyUsingLlmStreaming': '이미 LLM 스트리밍 번역을 사용 중입니다',
        ...
        'section.localInferenceSettings': '로컬 모델',
        'section.localModels': '로컬 모델',
        'label.asrBackend': '인식 백엔드',
        'asr.qwen': 'Qwen3 ASR (권장)',
        'asr.qwenAudio3': 'Qwen-Audio-3.1 ASR (최신)',
        ...
        'local.needsLocalVersion': '(LocalInference 버전 필요)',
        'localInference.engine.sensevoice': 'SenseVoice Small (빠름, CPU)',
        'localInference.engine.qwen3': 'Qwen3-ASR (정확, GPU)',
        'localInference.engine.sensevoiceName': 'SenseVoice Small',
        'localInference.engine.qwen3Name': 'Qwen3-ASR',
        'localInference.engine.sensevoiceHint': 'INT8 ONNX(CPU).',
        'localInference.engine.qwen3Hint': '두 개의 모델로 구성: 오디오 인코더(ONNX) + 인식 디코더(GGUF), 각각 CPU/GPU에 배치 가능.',
        'localInference.part.encoder': '오디오 인코더(ONNX)',
        'localInference.part.decoder': '인식 디코더(GGUF)',
        'localInference.placement.gpu': 'GPU',
        'localInference.placement.cpu': 'CPU',
        'localInference.vramLabel': 'VRAM',
        'localInference.vramTotal': '총 VRAM',
        'label.localEncoderDevice': '오디오 인코더 실행 위치',
        'option.encoderDeviceAuto': '위 설정과 동일',
        'option.encoderDeviceGpu': 'GPU(DirectML)',
        'option.encoderDeviceCpu': 'CPU',
        'hint.localEncoderDevice': 'GPU에 두면 훨씬 빠릅니다(24초 오디오 약 400ms → 70ms). 대신 VRAM을 더 씁니다. CPU는 GPU의 다른 부하에 영향받지 않아 게임 중에도 안정적입니다.',
        'label.sonioxKey': 'Soniox API Key (선택)',
        'hint.sonioxKey': '60개 이상의 언어 음성 인식을 지원합니다.',
        'label.pauseOnMute': '게임 음소거 시 전사 일시중지',
        'hint.pauseOnMute': '게임 내 마이크가 켜져 있을 때만 음성을 인식합니다',
        'label.enableHotWords': '핫워드 사용',
        'hint.enableHotWords': '특정 단어의 인식 정확도를 높입니다',
        'label.muteDelay': '음소거 지연(밀리초)',
        ...
        'hint.vadThreshold': '값이 클수록 엄격해져 잡음을 음성으로 오인하기 어렵습니다',
        ...
        'label.bypassOscUdpPortCheck': 'VRChat OSC 시작 경고 건너뛰기',
        'hint.bypassOscUdpPortCheck':
            '켜면 시작/다시 시작 시 UDP 포트 사용 여부를 확인하고 경고하지 않습니다(인게임 OSC에 문제가 생길 수 있습니다. 인지한 경우에만 사용하세요).',
        ...
        'option.micReselect': '마이크 선택이 만료되었습니다. 다시 선택하세요',
        'button.rescanMics': '장치 새로 고침',
        'option.micDisconnected': '선택한 마이크 연결 해제됨. 재연결 대기 중',
        ...
        'label.localInferenceEngine': '로컬 인식 엔진',
        'label.localInferenceDevice': '연산 장치',
        'label.localInferenceLanguage': '언어 힌트',
        'label.localVadMode': '로컬 VAD 모드',
        'label.localVadThreshold': '로컬 VAD 임계값',
        'label.localMinSpeechDuration': '최소 발화 길이(밀리초)',
        'label.localMaxSpeechDuration': '발화당 최대(밀리초)',
        'label.localSilenceDuration': '문장 종료 무음(밀리초)',
        'hint.localSilenceDuration': '연속 무음이 이 길이에 도달하면 문장이 끝난 것으로 판단해 최종 인식 결과를 제출합니다(로컬 인식 절단).',
        'label.localPreSpeechDuration': '발화 전 버퍼(밀리초)',
        'hint.localPreSpeechDuration': '발화 시작 시 앞으로 되돌려 채우는 오디오 길이. 온라인 API 게이팅과 로컬 인식 절단 모두에 적용되어 문장의 첫 글자가 놓치지 않습니다.',
        'label.localIncrementalAsr': '증분 인식 사용',
        'label.localIncrementalTriggerSilence': '증분 업데이트 무음(밀리초)',
        'hint.localIncrementalTriggerSilence': '발화 중에 이 길이의 짧은 멈춤이 있으면 한 절의 절단(쉼표 위치 등)으로 보고 증분 인식을 한 번 즉시 실행합니다.',
        'label.localIncrementalMinInterval': '최소 업데이트 간격(밀리초)',
        'hint.localIncrementalMinInterval': '율 제한: 증분 업데이트 두 번 사이의 최소 간격.',
        'label.localIncrementalFallbackInterval': '최대 업데이트 간격(밀리초)',
        'hint.localIncrementalFallbackInterval': '폴백: 이 시간 동안 업데이트가 전혀 없으면 중간 결과를 강제로 한 번 새로고칩니다.',
        'hint.localInferenceNotChecked': '로컬 ASR 모델 상태를 아직 확인하지 않았습니다',
        'hint.localInferenceStatus': '처음 사용하기 전에 선택한 엔진의 모델과 런타임을 먼저 다운로드하세요.',
        'hint.localInferenceNeedsDownload': '선택한 엔진이 아직 준비되지 않았습니다. 모델과 런타임을 먼저 다운로드하세요.',
        'status.downloading': '다운로드 중',
        'status.localInferenceReady': '{engine} 준비 완료',
        'btn.downloadLocalInference': '로컬 인식 모델 다운로드',
        ...
        'msg.udpPortOccupied': 'UDP 포트가 사용 중입니다. 서비스는 계속 시작되지만 게임이 OSC/자막을 받지 못할 수 있습니다.',
        'msg.udpPortBlockedCancel': '서비스는 계속 시작됩니다. 게임에 OSC/자막이 도착하지 않으면 해당 UDP 포트를 비우거나 점유 프로세스를 종료한 뒤 다시 시도하세요.',
        'msg.vrchatOscNotListeningWarning': 'VRChat이 로컬 UDP 포트 {port}에서 수신 대기 중인 것을 감지하지 못했습니다. 게임이 실행 중이 아니거나 OSC 포트가 꺼져 있을 수 있습니다. 켜려면 게임 내 원형 메뉴에서 Options > OSC로 이동해 스위치를 켜세요.',
        'msg.vrchatOscDisabledWarning': 'VRChat이 실행 중이지만 OSC가 켜져 있지 않습니다. 게임에서 Action Menu(원형 메뉴) 최상위의 Options → OSC를 Enabled로 켠 뒤 이 서비스를 다시 시작하세요.',
        'msg.vrchatOscPortMismatchWarning': 'VRChat이 OSC를 수신하는 포트는 {actualPort}로, 현재 설정된 전송 포트 {port}와 다릅니다. 메시지가 게임에 전달되지 않을 수 있습니다. 고급 설정에서 OSC 전송 대상 포트를 {actualPort}로 변경하세요.',
        ...
        'msg.localInferenceDownloadStarted': '로컬 ASR 모델 다운로드를 시작했습니다',
        'msg.localInferenceDownloadFailed': '로컬 ASR 모델 다운로드에 실패했습니다',
        'msg.localInferenceDisabledInBuild': '이 표준 빌드에서는 로컬 ASR 이 비활성화되어 있습니다',
        'msg.localInferenceNotReady': '로컬 ASR 모델이 아직 준비되지 않았습니다. 먼저 다운로드하세요',
        'msg.localInferenceNeedPythonDeps': '모델은 있으나 Python 패키지 부족: {deps}. pip install -r requirements-local-inference.txt 후 재시작.',
        'msg.localInferenceNeedSilero': 'Silero VAD(ONNX) 없음. 로컬 ASR에서 다운로드.',
        ...
        'msg.simpleDashscopeKeyMissing': '간편 모드에서 음성 인식을 시작하려면 Alibaba Cloud DashScope API Key가 필요합니다.',
        'msg.simpleDeepseekKeyMissing': '번역이 켜져 있으므로 간편 모드에는 DeepSeek API Key가 필요합니다.',
