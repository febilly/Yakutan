...
const translations = {
    'zh-CN': {
        ...
        'localAsr.engine.sensevoiceHint': 'INT8 ONNX，固定 CPU；本地识别构建已内置模型。',
    ...
    'en': {
        ...
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        'localAsr.engine.sensevoiceHint': 'INT8 ONNX on CPU; bundled in Local ASR build.',
    ...
    'ja': {
        ...
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        'localAsr.engine.sensevoiceHint': 'INT8 ONNX（CPU）。ローカル ASR ビルドに同梱。',
    ...
    'ko': {
        ...
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        'localAsr.engine.sensevoiceHint': 'INT8 ONNX(CPU). 로컬 ASR 빌드에 포함.',
