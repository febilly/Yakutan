...
const translations = {
    'zh-CN': {
        ...
        'status.hymt2Missing': '❌ 未就绪（请放置 GGUF 模型文件至 local_asr_models/hymt2/）',
        ...
        'asr.qwenAudio3': 'Qwen-Audio-3.0 ASR（最新，支持即时热词）',
    ...
    'en': {
        ...
        'status.hymt2Missing': '❌ Not ready (place the GGUF model file in local_asr_models/hymt2/)',
        ...
        'asr.qwenAudio3': 'Qwen-Audio-3.0 ASR (Latest, inline hot words)',
    ...
    'ja': {
        ...
        'status.hymt2Missing': '❌ 未準備（GGUF モデルファイルを local_asr_models/hymt2/ に配置してください）',
        ...
        'asr.qwenAudio3': 'Qwen-Audio-3.0 ASR（最新・即時ホットワード対応）',
    ...
    'ko': {
        ...
        'status.hymt2Missing': '❌ 준비되지 않음 (GGUF 모델 파일을 local_asr_models/hymt2/ 에 넣어 주세요)',
        ...
        'asr.qwenAudio3': 'Qwen-Audio-3.0 ASR (최신, 즉시 핫워드 지원)',
