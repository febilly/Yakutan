...
const translations = {
    'zh-CN': {
        ...
        'hint.hymt2LocalDevice': '仅影响本地 Hy-MT2 模型；切换后下一次翻译会用新设置重新加载模型。',
    ...
    'en': {
        ...
        'hint.hymt2LocalDevice': 'Applies to the local Hy-MT2 model only; the model reloads with the new setting on the next translation.',
    ...
    'ja': {
        ...
        'hint.hymt2LocalDevice': 'ローカル Hy-MT2 モデルのみに適用されます。切り替え後、次の翻訳時に新しい設定でモデルを再読み込みします。',
    ...
    'ko': {
        ...
        'hint.hymt2LocalDevice': '로컬 Hy-MT2 모델에만 적용되며, 변경 후 다음 번역에서 새 설정으로 모델을 다시 불러옵니다.',
