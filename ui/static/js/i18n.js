...
const translations = {
    'zh-CN': {
        ...
        'asr.local': '本地识别（SenseVoice / Fun-ASR / Qwen3）',
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.funasrNano': 'Fun-ASR-Nano',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        ...
        'option.cpu': 'CPU',
        'option.cuda': 'CUDA',
        'option.modelscope': 'ModelScope',
        'option.huggingface': 'HuggingFace',
        'option.localVadSilero': 'Silero',
        'option.localVadEnergy': '能量检测',
        'option.localVadDisabled': '禁用',
        'option.localSilenceAuto': '自动',
        'option.localSilenceFixed': '固定',
        'label.localAsrEngine': '本地识别引擎',
        'label.localAsrDevice': '计算设备',
        'label.localAsrHub': '模型来源',
        ...
        'label.localMaxSpeechDuration': '单段最长语音采集（秒），超时后仅送静音直至本段结束或闭麦',
        'label.localSilenceMode': '静音模式',
    ...
    'en': {
        ...
        'asr.local': 'Local ASR (SenseVoice / Fun-ASR / Qwen3)',
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.funasrNano': 'Fun-ASR-Nano',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        ...
        'option.localSilenceAuto': 'Auto',
        'option.localSilenceFixed': 'Fixed',
        'label.localAsrEngine': 'Local ASR Engine',
        'label.localAsrDevice': 'Compute Device',
        'label.localAsrHub': 'Model Source',
        ...
        'label.localMaxSpeechDuration': 'Max speech per utterance (s); after cap, silence fed until segment ends or mute',
        'label.localSilenceMode': 'Silence Mode',
    ...
    'ja': {
        ...
        'asr.local': 'ローカル ASR（SenseVoice / Fun-ASR / Qwen3）',
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.funasrNano': 'Fun-ASR-Nano',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        ...
        'label.localMaxSpeechDuration': '1発話あたり最長（秒）、超過後は無音のみ送り区切り/ミュートまで',
        'label.localSilenceMode': '無音モード',
    ...
    'ko': {
        ...
        'asr.local': '로컬 ASR (SenseVoice / Fun-ASR / Qwen3)',
        'localAsr.engine.sensevoice': 'SenseVoice Small',
        'localAsr.engine.funasrNano': 'Fun-ASR-Nano',
        'localAsr.engine.qwen3': 'Qwen3-ASR',
        ...
        'option.localSilenceAuto': '자동',
        'option.localSilenceFixed': '고정',
        'label.localAsrEngine': '로컬 인식 엔진',
        'label.localAsrDevice': '연산 장치',
        'label.localAsrHub': '모델 소스',
        ...
        'label.localMaxSpeechDuration': '발화당 최대(초), 초과 시 무음만 보냄(구간 끝/뮤트까지)',
        'label.localSilenceMode': '무음 모드',
