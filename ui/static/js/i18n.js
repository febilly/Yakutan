...
const translations = {
    'zh-CN': {
        ...
        'label.localSilenceDuration': '句子结束静音（秒）',
        ...
        'label.localIncrementalMinInterval': '增量更新最小间隔（秒）',
        'hint.localIncrementalMinInterval': '限流：两次增量更新之间的最小间隔。',
        'label.localIncrementalFallbackInterval': '增量更新最长间隔（秒）',
    ...
    'en': {
        ...
        'label.localSilenceDuration': 'Sentence End Silence (s)',
        ...
        'label.localIncrementalMinInterval': 'Min Update Interval (s)',
        'hint.localIncrementalMinInterval': 'Rate limit: minimum gap between two incremental updates.',
        'label.localIncrementalFallbackInterval': 'Max Update Interval (s)',
    ...
    'ja': {
        ...
        'label.localSilenceDuration': '文終わり無音（秒）',
        ...
        'label.localIncrementalMinInterval': '更新最小間隔（秒）',
        'hint.localIncrementalMinInterval': 'レート制限：2回の増量更新の間隔の下限。',
        'label.localIncrementalFallbackInterval': '更新最大間隔（秒）',
    ...
    'ko': {
        ...
        'label.localSilenceDuration': '문장 종료 무음(초)',
        ...
        'label.localIncrementalMinInterval': '최소 업데이트 간격(초)',
        'hint.localIncrementalMinInterval': '율 제한: 증분 업데이트 두 번 사이의 최소 간격.',
        'label.localIncrementalFallbackInterval': '최대 업데이트 간격(초)',
