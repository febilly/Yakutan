...
const translations = {
    'zh-CN': {
        ...
        'localInference.engine.qwen3Hint': '在 GPU 上运行（Vulkan/DirectML），约需 1.6GB 显存。',
    ...
    'en': {
        ...
        'localInference.engine.qwen3Hint': 'Runs on GPU (Vulkan/DirectML); about 1.6GB VRAM.',
    ...
    'ja': {
        ...
        'localInference.engine.qwen3Hint': 'GPU（Vulkan/DirectML）で動作。VRAM 約 1.6GB。',
    ...
    'ko': {
        ...
        'localInference.engine.qwen3Name': 'Qwen3-ASR',
        'localInference.engine.sensevoiceHint': 'INT8 ONNX(CPU).',
        'localInference.engine.qwen3Hint': 'GPU(Vulkan/DirectML)에서 실행, VRAM 약 1.6GB.',
