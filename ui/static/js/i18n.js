...
const translations = {
    'zh-CN': {
        ...
        'hint.localAsrDevice': '仅对 Qwen3-ASR 生效；SenseVoice 固定在 CPU 上运行。',
        ...
        'label.localAsrModels': '🎙️ 语音识别模型（ASR）',
        ...
        'localAsr.engine.sensevoiceName': 'SenseVoice Small',
        'localAsr.engine.qwen3Name': 'Qwen3-ASR',
    ...
    'en': {
        ...
        'hint.localAsrDevice': 'Applies to Qwen3-ASR only; SenseVoice always runs on the CPU.',
        ...
        'label.localAsrModels': '🎙️ Speech Recognition Models (ASR)',
        ...
        'section.localAsrSettings': 'Local Models',
    ...
    'ja': {
        ...
        'hint.localAsrDevice': 'Qwen3-ASR にのみ適用されます。SenseVoice は常に CPU で動作します。',
        ...
        'label.localAsrModels': '🎙️ 音声認識モデル（ASR）',
        ...
        'section.localAsrSettings': 'ローカルモデル',
    ...
    'ko': {
        ...
        'hint.localAsrDevice': 'Qwen3-ASR 에만 적용되며, SenseVoice 는 항상 CPU 에서 실행됩니다.',
        ...
        'label.localAsrModels': '🎙️ 음성 인식 모델 (ASR)',
        ...
        'section.localAsrSettings': '로컬 모델',
